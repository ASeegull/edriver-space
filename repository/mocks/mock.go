...
// MockParkingFines is a mock of ParkingFines interface.
type MockParkingFines struct {
	ctrl     *gomock.Controller
	recorder *MockParkingFinesMockRecorder
}

// MockParkingFinesMockRecorder is the mock recorder for MockParkingFines.
type MockParkingFinesMockRecorder struct {
	mock *MockParkingFines
}

// NewMockParkingFines creates a new mock instance.
func NewMockParkingFines(ctrl *gomock.Controller) *MockParkingFines {
	mock := &MockParkingFines{ctrl: ctrl}
	mock.recorder = &MockParkingFinesMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use.
func (m *MockParkingFines) EXPECT() *MockParkingFinesMockRecorder {
	return m.recorder
}

// AddParkingFine mocks base method.
func (m *MockParkingFines) AddParkingFine(ctx context.Context, fine model.ParkingFine) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "AddParkingFine", ctx, fine)
	ret0, _ := ret[0].(error)
	return ret0
}

// AddParkingFine indicates an expected call of AddParkingFine.
func (mr *MockParkingFinesMockRecorder) AddParkingFine(ctx, fine interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "AddParkingFine", reflect.TypeOf((*MockParkingFines)(nil).AddParkingFine), ctx, fine)
}

// DeleteParkingFine mocks base method.
func (m *MockParkingFines) DeleteParkingFine(ctx context.Context, id string) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "DeleteParkingFine", ctx, id)
	ret0, _ := ret[0].(error)
	return ret0
}

// DeleteParkingFine indicates an expected call of DeleteParkingFine.
func (mr *MockParkingFinesMockRecorder) DeleteParkingFine(ctx, id interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "DeleteParkingFine", reflect.TypeOf((*MockParkingFines)(nil).DeleteParkingFine), ctx, id)
}

// GetParkingFine mocks base method.
func (m *MockParkingFines) GetParkingFine(ctx context.Context, id string) (*model.ParkingFine, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetParkingFine", ctx, id)
	ret0, _ := ret[0].(*model.ParkingFine)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// GetParkingFine indicates an expected call of GetParkingFine.
func (mr *MockParkingFinesMockRecorder) GetParkingFine(ctx, id interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetParkingFine", reflect.TypeOf((*MockParkingFines)(nil).GetParkingFine), ctx, id)
}

// GetParkingFines mocks base method.
func (m *MockParkingFines) GetParkingFines(ctx context.Context) ([]model.ParkingFine, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetParkingFines", ctx)
	ret0, _ := ret[0].([]model.ParkingFine)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// GetParkingFines indicates an expected call of GetParkingFines.
func (mr *MockParkingFinesMockRecorder) GetParkingFines(ctx interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetParkingFines", reflect.TypeOf((*MockParkingFines)(nil).GetParkingFines), ctx)
}
